...
class GenericViewModelFactory(private val appComponent: AppComponent) : ViewModelProvider.Factory {
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        return when {
            ...
            modelClass.isAssignableFrom(DetailsViewModel::class.java) -> DetailsViewModel(appComponent) as T
            modelClass.isAssignableFrom(CharactersViewModel::class.java) -> CharactersViewModel(appComponent) as T
            modelClass.isAssignableFrom(BookmarkViewModel::class.java) -> BookmarkViewModel(appComponent) as T
