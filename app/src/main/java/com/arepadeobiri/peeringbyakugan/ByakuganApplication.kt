...
import com.arepadeobiri.peeringbyakugan.daggerUtil.AppModule
import com.arepadeobiri.peeringbyakugan.daggerUtil.DaggerAppComponent
import com.arepadeobiri.peeringbyakugan.work.BookmarkNotificationWorker
...
class ByakuganApplication : Application() {
    ...
    private fun setupRecurringWork() {
        ...
        val repeatingRequest = PeriodicWorkRequestBuilder<BookmarkNotificationWorker>(
            24,
            TimeUnit.HOURS,
            12,
            TimeUnit.HOURS
